...
{
    public MapManager map; //The only MapManager there is in the scene

    [SerializeField] private LayerMask obstacleMask; // assign in Inspector for raycasting (select Obstacle and Ignore Raycasting)
